...
class PredicateResolutionTest(parameterized.TestCase, tf.test.TestCase):
  ...
  def testCreateProtoOp(self):
    ...
    # dsl/placeholder/placeholder_test.pyplaceholder_test.py already
    # asserts that the DSL results in the PlaceholderExpression stored in
    # testdata. This test here asserts that the same PlaceholderExpression can
    # be resolved even when the respective proto (SplitConfig) isn't linked
    # into the binary (a vital precondition for this test):

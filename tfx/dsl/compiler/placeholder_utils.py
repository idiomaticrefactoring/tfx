...
class _ExpressionResolver:
  ...
  @_register(placeholder_pb2.CreateDictOperator)
  def _resolve_create_dict_operator(
      self, op: placeholder_pb2.CreateDictOperator
  ) -> Dict[str, Any]:
    """Evaluates the create dict operator."""
    result = {}
